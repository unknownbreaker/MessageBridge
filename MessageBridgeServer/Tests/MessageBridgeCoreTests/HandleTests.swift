...
final class HandleTests: XCTestCase {
    ...
    func testDisplayName_withContactName_returnsContactName() {
        let handle = Handle(id: 1, address: "+15551234567", service: "iMessage", contactName: "Jane Smith")
    ...
    func testCodable_withContactName_encodesAndDecodes() throws {
        let original = Handle(id: 1, address: "+15551234567", service: "iMessage", contactName: "Test User")
