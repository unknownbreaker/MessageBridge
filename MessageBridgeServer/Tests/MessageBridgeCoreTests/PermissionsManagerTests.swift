...
final class PermissionsManagerTests: XCTestCase {
    ...
    func testPermissionsManager_checkAllPermissions_hasSettingsURLs() async {
        ...
        for permission in permissions {
            XCTAssertNotNil(permission.settingsURL, "Permission \(permission.id) should have a settings URL")
        }
    }
    ...
    func testPermissionsManager_checkAllPermissions_hasDescriptions() async {
        ...
        for permission in permissions {
            XCTAssertFalse(permission.description.isEmpty, "Permission \(permission.id) should have a description")
        }
    }
