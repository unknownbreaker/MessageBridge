...
final class AttachmentTests: XCTestCase {
    ...
    func testFormattedSize_withBytes_formatsCorrectly() {
        ...
        XCTAssertTrue(attachment.formattedSize.contains("500") || attachment.formattedSize.lowercased().contains("byte"))
    }
    ...
    func testFormattedSize_withKilobytes_formatsCorrectly() {
        ...
        XCTAssertTrue(attachment.formattedSize.contains("KB"), "Expected KB in '\(attachment.formattedSize)'")
    }
    ...
    func testFormattedSize_withMegabytes_formatsCorrectly() {
        ...
        XCTAssertTrue(attachment.formattedSize.contains("MB"), "Expected MB in '\(attachment.formattedSize)'")
    }
    ...
    func testFormattedSize_withGigabytes_formatsCorrectly() {
        ...
        XCTAssertTrue(attachment.formattedSize.contains("GB"), "Expected GB in '\(attachment.formattedSize)'")
    }
    ...
    func testMessage_withMultipleAttachments_returnsAll() {
        let attachments = [
            Attachment(id: 1, guid: "att-1", filename: "photo1.jpg", mimeType: "image/jpeg", uti: nil, size: 1000, isOutgoing: false, isSticker: false),
            Attachment(id: 2, guid: "att-2", filename: "photo2.jpg", mimeType: "image/jpeg", uti: nil, size: 2000, isOutgoing: false, isSticker: false),
            Attachment(id: 3, guid: "att-3", filename: "video.mp4", mimeType: "video/mp4", uti: nil, size: 5000000, isOutgoing: false, isSticker: false)
        ]
