...
struct SettingsView: View {
    ...
    var body: some View {
        TabView {
            GeneralSettingsView(portText: $portText, showRegenerateConfirmation: $showRegenerateConfirmation)
    ...
    var body: some View {
        Form {
            Section {
                ...
                Text("The API key is required for clients to connect. Keep it secure and share only with trusted devices.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
            }
        }
        ...
        .alert("Regenerate API Key?", isPresented: $showRegenerateConfirmation) {
            ...
            Text("This will invalidate the current API key. All connected clients will need to be updated with the new key.")
        }
    }
}
...
struct AboutView: View {
    var body: some View {
        VStack(spacing: 16) {
            ...
            Link("View on GitHub", destination: URL(string: "https://github.com/unknownbreaker/MessageBridge")!)
                .font(.caption)
        }
        .padding()
